...
public class RegValidator extends Validator {
	...
	protected void validate(Controller controller) {
		...
		if (actionKey.equals(T3userController.pthc+"doReg")){
			 validateString("t3user.account", 6, 12, "accountMsg", "The account is made up 6 to 12 letters and numbers");
			 ...
			 validateString("t3user.phone", 1, 10, "phoneMsg", "Please enter the vaild mobile");
			 validateEmail("t3user.email","emailMsg", "Please input the vaild email");
...
//			 validateString("t3user.industry", 1, 80, "industryMsg", "Please enter industry name from 1 to 80 digits in length!");
			 ...
			 validateEmail("t3user.email","emailMsg", "Please input the vaild email");
			 validateString("t3user.name_", 1, 180, "name_", "Please enter the user name from 1 to 180 digits in length");
//			 validateString("t3user.company", 1, 240, "companyMsg", "Please enter company name from 1 to 240 lengths");
//			 validateString("t3user.industry", 1, 80, "industryMsg", "Please enter industry name from 1 to 80 digits in length");
