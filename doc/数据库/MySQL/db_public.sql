...
CREATE TABLE `pt_syslog` (
  ...
  `actionstartdate` timestamp not NULL default '1970-01-02 00:00:00',
  ...
  `startdate` timestamp not NULL default '1970-01-02 00:00:00',
...
CREATE TABLE `pt_userinfo` (
  ...
  `clientlevelstart` timestamp not NULL default '1970-01-02 00:00:00',
