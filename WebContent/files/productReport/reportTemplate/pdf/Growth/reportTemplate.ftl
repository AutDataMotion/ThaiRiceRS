    ...
    <div style="margin-left:auto;margin-right:auto;text-align: center;">  
        ...
        <table class="reportDesTable" border="1">
			...
			<tr style="background:gray;">
				...
				<td colspan="1" rowspan="2">ChildAreaName</td>
				<td colspan="5">Growth(proportion)</td>			
            </tr>
			<tr style="background:gray;">
				<td colspan="1">Very Bad</td>  
				<td colspan="1">Bad</td>
			...
			<tr>
				<td colspan="1">${growth.code}</td>  
				<td colspan="1">${growth.name}</td>
				<td colspan="1">${growth.moist}</td>
				<td colspan="1">${growth.normal}</td>
				<td colspan="1">${growth.lightdrought}</td>
				<td colspan="1">${growth.middling}</td>
				<td colspan="1">${growth.heavy}</td>					
            </tr>
			</#list> 
