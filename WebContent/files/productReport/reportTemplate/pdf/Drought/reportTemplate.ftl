    ...
    <div style="margin-left:auto;margin-right:auto;text-align: center;">  
        ...
        <table class="reportDesTable" border="1">
			...
			<tr style="background:gray;">
				...
				<td colspan="5">Drought(proportion)</td>			
            </tr>
			<tr style="background:gray;">
			...
			<tr>
				<td colspan="1">${drought.code}</td>  
				<td colspan="1">${drought.name}</td>
				<td colspan="1">${drought.moist}</td>
				<td colspan="1">${drought.normal}</td>
				<td colspan="1">${drought.lightdrought}</td>
				<td colspan="1">${drought.middling}</td>
				<td colspan="1">${drought.heavy}</td>					
            </tr>
			</#list> 
