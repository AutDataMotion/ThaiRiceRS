...
public abstract class BaseMapping {
    ...
    public abstract void start(Plugins plugins,PropertiesPlugin aproperity);
    
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public void scan(PropertiesPlugin propertiesPlugin) {
		// 查询所有继承BaseModel、BaseModelCache的子类
		List<String> jarsList = (List<String>) propertiesPlugin
				.getparamMapMy(ConstantInit.config_scan_jar);
