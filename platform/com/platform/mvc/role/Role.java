...
public class Role extends BaseModelCache<Role> {
	...
	public static final String sqlId_allid = "platform.role.allid";
	...
	public void cacheAdd(String ids){
		cacheAdd(Role.dao.findById(ids));
	}

	public void cacheAdd(Role role){
		ToolCache.set(ParamInitPlugin.cacheStart_role + role.getStr(column_ids), role);
	}
	/**
	 * 删除缓存
	 */
