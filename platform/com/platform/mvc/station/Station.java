...
public class Station extends BaseModelCache<Station> {
	...
	public static final String sqlId_allid = "platform.station.allid";
	...
	public void cacheAdd(String ids){
		cacheAdd(Station.dao.findById(ids));
	}
	
	public void cacheAdd(Station station){
		ToolCache.set(ParamInitPlugin.cacheStart_station + station.getStr(column_ids), station);
	}
