...
public abstract class ToolWeb {
	...
	public static String getContextPath(HttpServletRequest request) {
		...
		//sb.append(request.getScheme()).append("://").append("192.168.0.236").append(":").append(request.getServerPort()).append(request.getContextPath());
	 ...
	 * 输出servlet文本内容
	 * 
	 * @author DHJ 2012-9-14 下午8:04:01
	 * @param response
	 * @param content
	 * @param contentType
	 */
	 ...
	 * 输出CSV文件下载
	 * 
	 * @author DHJ 2012-9-14 下午8:02:33
	 * @param response
	 * @param content CSV内容
	 */
