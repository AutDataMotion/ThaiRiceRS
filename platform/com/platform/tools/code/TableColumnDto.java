...
public class TableColumnDto {
	...
	public void setColumn_name_upperCaseFirstOne(
			String column_name_upperCaseFirstOne) {
	...
	public void setColumn_className(String column_className) {
		column_className = column_className.substring(column_className
				.lastIndexOf(".") + 1);
	...
	public boolean TypeIsChar() {
		...
		return clm_type.contains("char") ? true : false;
	}

	public boolean TypeIsText() {

		return clm_type.contains("text") ? true : false;
	}

	public boolean TypeIsDate() {

		return clm_type.contains("time") ? true : false;
	}

	public boolean TypeIsBool() {
		return clm_type.contains("boo") ? true : false;
	}
	
	public boolean TypeIsInt() {
		return clm_type.contains("int") ? true : false;
	}
